...
<body>
            ...
            <div class="container"><a class="navbar-brand" href="#">Land Registry System</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="Signup-1.php">Register</a></li>
    ...
    <div class="container-fluid">
        <div style="border-radius:5px;background-image:url(&quot;assets/img/top-view-photo-of-river-near-farmland-2476015.jpg&quot;);width:100%;height:750px;background-repeat:no-repeat;background-size:cover;background-position:center;">
            <div class="row float-right" style="margin-top:10%;margin-right:2%;">
                <div class="col-7" style="background-color:#000000;">
                    <div class="float-left" style="margin-top:15%;">
                        ...
                        <p class="text-center" style="background-color:rgba(255,255,255,0);color:#999999;">The easiest, secure and convinient way for your land transactions</p>
                        <p></p>
                        <div class="row">
                            <div class="col"><button class="btn btn-outline-primary" style="width:100%;margin-left:auto;margin-right:auto;" type="button">Learn More</button></div>
                        </div>
                    </div>
                </div>
